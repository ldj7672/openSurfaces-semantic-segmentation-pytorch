...
from os_data import ValDataset_os

import random
colors = loadmat('dataset/color150.mat')['colors']
    ...
    for batch_data in loader:
        ...
        with torch.no_grad():
            ...
            for img in img_resized_list:
                ...
                if 'info' in list(feed_dict.keys()):
                    del feed_dict['info']
...
def worker(cfg, gpu_id, start_idx, end_idx, result_queue):
    ...
    dataset_test = ValDataset_os(os_dataset.record_list['validation'], cfg.DATASET)
